...
class DetailsFragmentMap (val supportFragmentManager: SupportMapFragment) : BaseFragment<FragmentDetailBinding, DetailFragmentViewModel, MainActivity>(),
    OnMapReadyCallback {

    val ZOOM_LEVEL = 10.0F

    override val mViewModelClass: Class<DetailFragmentViewModel>
